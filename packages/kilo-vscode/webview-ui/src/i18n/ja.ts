...
export const dict = {
  ...
  "settings.aboutKiloCode.checkForUpdates": "更新を確認",
  "settings.cloud.title": "クラウド",
  "settings.cloud.description": "Babel Code Cloud に接続して、更新とクラウド機能を利用します。",
  "settings.cloud.signIn": "サインイン",
