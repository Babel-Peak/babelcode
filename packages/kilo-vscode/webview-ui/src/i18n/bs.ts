...
export const dict = {
  ...
  "settings.aboutKiloCode.checkForUpdates": "Provjeri ažuriranja",
  "settings.cloud.title": "Oblak",
  "settings.cloud.description": "Povežite Babel Code Cloud za ažuriranja i pristup funkcijama oblaka.",
  "settings.cloud.signIn": "Prijavi se",
