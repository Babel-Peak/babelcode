...
export const dict = {
  ...
  "settings.aboutKiloCode.checkForUpdates": "Controleren op updates",
  "settings.cloud.title": "Cloud",
  "settings.cloud.description": "Verbind Babel Code Cloud om updates te ontvangen en cloudfuncties te gebruiken.",
  "settings.cloud.signIn": "Aanmelden",
