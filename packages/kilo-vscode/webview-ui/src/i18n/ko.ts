...
export const dict = {
  ...
  "settings.aboutKiloCode.checkForUpdates": "업데이트 확인",
  "settings.cloud.title": "클라우드",
  "settings.cloud.description": "업데이트와 클라우드 기능을 사용하려면 Babel Code Cloud에 연결하세요.",
  "settings.cloud.signIn": "로그인",
