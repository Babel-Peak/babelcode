...
export const dict = {
  ...
  "deviceAuth.title": "Accedi a Babel Code",
  ...
  "profile.action.login": "Accedi con Babel Code",
  ...
  "settings.aboutKiloCode.title": "Informazioni su Babel Code",
  "session.messages.welcome":
    "Babel Code è un assistente AI per il coding. Chiedigli di creare feature, correggere bug o spiegare il codebase.",
  ...
  "settings.aboutKiloCode.checkForUpdates": "Controlla aggiornamenti",
  "settings.cloud.title": "Cloud",
  "settings.cloud.description":
    "Connetti Babel Code Cloud per ricevere aggiornamenti e accedere alle funzionalità cloud.",
  ...
  "settings.language.description": 'Scegli la lingua dell\'interfaccia Babel Code. "Auto" usa la lingua di VS Code.',
  ...
  "settings.providers.modeModels.variant": "Ragionamento predefinito",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migra le impostazioni da una precedente installazione di Babel Code, incluse API key dei provider e modello predefinito.",
  ...
  "migration.whatsNew.title": "Novità in Babel Code",
