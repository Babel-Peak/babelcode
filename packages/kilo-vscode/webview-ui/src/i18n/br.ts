...
export const dict = {
  ...
  "settings.aboutKiloCode.checkForUpdates": "Verificar atualizações",
  "settings.cloud.title": "Nuvem",
  "settings.cloud.description": "Conecte o Babel Code Cloud para receber atualizações e acessar recursos da nuvem.",
