...
export const dict = {
  ...
  "settings.aboutKiloCode.checkForUpdates": "التحقق من التحديثات",
  "settings.cloud.title": "السحابة",
  "settings.cloud.description": "اتصل بسحابة Babel Code لتلقي التحديثات والوصول إلى ميزات السحابة.",
