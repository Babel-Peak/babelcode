export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Babel Code オートコンプリート",
  ...
  "kilocode:autocomplete.codeAction.title": "Babel Code: 提案された編集",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Babel Code オートコンプリートは GitHub Copilot との競合によりブロックされています。修正するには、Copilot のインライン提案を無効にする必要があります。",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Babel Code オートコンプリートは一時停止されました。考えられる原因: Kilo アカウントに残りクレジットがない、または設定済みの API キー (BYOK) がクォータ上限に達しています。オートコンプリートを再開するには、Kilo クレジットを追加するか API キー設定を確認してください。",
  "kilocode:autocomplete.creditsExhausted.addCredits": "クレジットを追加",
  "kilocode:autocomplete.authError.message":
    "Babel Code オートコンプリートは認証の問題により一時停止されました。考えられる原因: Kilo にサインインしていない、または API キー (BYOK) が無効または不足しています。再度サインインするか、プロバイダーの API キー設定を確認してください。",
}
