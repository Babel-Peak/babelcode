export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Completamento automatico Babel Code",
  ...
  "kilocode:autocomplete.codeAction.title": "Babel Code: modifiche suggerite",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Il completamento automatico di Babel Code è bloccato da un conflitto con GitHub Copilot. Per risolvere il problema, devi disabilitare i suggerimenti inline di Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Il completamento automatico di Babel Code è stato messo in pausa. Possibili cause: il tuo account Kilo non ha crediti residui, oppure la chiave API configurata (BYOK) ha raggiunto il limite di quota. Aggiungi crediti Kilo o controlla la configurazione della chiave API per riprendere il completamento automatico.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Aggiungi crediti",
  "kilocode:autocomplete.authError.message":
    "Il completamento automatico di Babel Code è stato messo in pausa a causa di un problema di autenticazione. Possibili cause: non hai effettuato l’accesso a Kilo, oppure la tua chiave API (BYOK) non è valida o manca. Accedi di nuovo o controlla le impostazioni della chiave API del provider.",
}
