export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Babel Code autofuldførelse",
  ...
  "kilocode:autocomplete.codeAction.title": "Babel Code: Foreslåede redigeringer",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Babel Code autofuldførelse blokeres af en konflikt med GitHub Copilot. For at løse dette skal du deaktivere Copilots inline-forslag.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Babel Code autofuldførelse er sat på pause. Mulige årsager: din Kilo-konto har ingen resterende credits, eller din konfigurerede API-nøgle (BYOK) har nået sin kvotegrænse. Tilføj Kilo-credits eller kontroller din API-nøglekonfiguration for at genoptage autocomplete.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Tilføj credits",
  "kilocode:autocomplete.authError.message":
    "Babel Code autofuldførelse er sat på pause på grund af et godkendelsesproblem. Mulige årsager: du er ikke logget ind på Kilo, eller din API-nøgle (BYOK) er ugyldig eller mangler. Log ind igen, eller kontroller indstillingerne for udbyderens API-nøgle.",
}
