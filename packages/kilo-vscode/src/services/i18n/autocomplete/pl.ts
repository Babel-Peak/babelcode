export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Autouzupełnianie Babel Code",
  ...
  "kilocode:autocomplete.codeAction.title": "Babel Code: Sugerowane edycje",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Autouzupełnianie Babel Code jest blokowane przez konflikt z GitHub Copilot. Aby to naprawić, musisz wyłączyć sugestie inline Copilota.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Autouzupełnianie Babel Code zostało wstrzymane. Możliwe przyczyny: konto Kilo nie ma pozostałych kredytów albo skonfigurowany klucz API (BYOK) osiągnął limit kwoty. Dodaj kredyty Kilo albo sprawdź konfigurację klucza API, aby wznowić autouzupełnianie.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Dodaj kredyty",
  "kilocode:autocomplete.authError.message":
    "Autouzupełnianie Babel Code zostało wstrzymane z powodu problemu z uwierzytelnianiem. Możliwe przyczyny: nie zalogowano się do Kilo albo klucz API (BYOK) jest nieprawidłowy lub go brakuje. Zaloguj się ponownie albo sprawdź ustawienia klucza API dostawcy.",
}
