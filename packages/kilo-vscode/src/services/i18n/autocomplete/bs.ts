export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Babel Code automatsko dovršavanje",
  ...
  "kilocode:autocomplete.codeAction.title": "Babel Code: Predložene izmjene",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Babel Code automatsko dovršavanje blokira sukob s GitHub Copilotom. Da to popravite, morate onemogućiti Copilotove inline prijedloge.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Babel Code automatsko dovršavanje je pauzirano. Mogući uzroci: vaš Kilo račun nema preostalih kredita ili je vaš konfigurisani API ključ (BYOK) dostigao ograničenje kvote. Dodajte Kilo kredite ili provjerite konfiguraciju API ključa da nastavite automatsko dovršavanje.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Dodaj kredite",
  "kilocode:autocomplete.authError.message":
    "Babel Code automatsko dovršavanje je pauzirano zbog problema s autentifikacijom. Mogući uzroci: niste prijavljeni u Kilo ili je vaš API ključ (BYOK) nevažeći ili nedostaje. Prijavite se ponovo ili provjerite postavke API ključa pružaoca.",
}
