export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Автодополнение Babel Code",
  ...
  "kilocode:autocomplete.codeAction.title": "Babel Code: Предлагаемые правки",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Автодополнение Babel Code блокируется из-за конфликта с GitHub Copilot. Чтобы исправить это, необходимо отключить встроенные предложения Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Автодополнение Babel Code приостановлено. Возможные причины: на вашем аккаунте Kilo не осталось кредитов или настроенный API-ключ (BYOK) достиг лимита квоты. Добавьте кредиты Kilo или проверьте конфигурацию API-ключа, чтобы возобновить автодополнение.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Добавить кредиты",
  "kilocode:autocomplete.authError.message":
    "Автодополнение Babel Code приостановлено из-за проблемы с аутентификацией. Возможные причины: вы не вошли в Kilo или ваш API-ключ (BYOK) недействителен либо отсутствует. Войдите снова или проверьте настройки API-ключа провайдера.",
}
