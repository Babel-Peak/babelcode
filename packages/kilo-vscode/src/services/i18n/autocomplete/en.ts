...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Babel Code Autocomplete",
  ...
  "kilocode:autocomplete.codeAction.title": "Babel Code: Suggested Edits",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "The Babel Code Autocomplete is being blocked by a conflict with GitHub Copilot. To fix this, you must disable Copilot's inline suggestions.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Babel Code Autocomplete has been paused. Possible causes: your Kilo account has no remaining credits, or your configured API key (BYOK) has reached its quota limit. Add Kilo credits or check your API key configuration to resume autocomplete.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Add Credits",
  "kilocode:autocomplete.authError.message":
    "Babel Code Autocomplete has been paused due to an authentication issue. Possible causes: you are not signed in to Kilo, or your API key (BYOK) is invalid or missing. Please sign in again or check your provider API key settings.",
}
