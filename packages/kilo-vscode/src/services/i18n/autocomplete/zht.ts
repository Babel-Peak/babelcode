export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Babel Code 自動完成",
  ...
  "kilocode:autocomplete.codeAction.title": "Babel Code：建議的編輯",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Babel Code 自動完成因與 GitHub Copilot 衝突而被封鎖。若要修正此問題，必須停用 Copilot 的內嵌建議。",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Babel Code 自動完成已暫停。可能原因：你的 Kilo 帳戶沒有剩餘額度，或你設定的 API 金鑰（BYOK）已達到配額限制。請新增 Kilo 額度或檢查 API 金鑰設定以恢復自動完成。",
  "kilocode:autocomplete.creditsExhausted.addCredits": "新增額度",
  "kilocode:autocomplete.authError.message":
    "Babel Code 自動完成因驗證問題已暫停。可能原因：你尚未登入 Kilo，或你的 API 金鑰（BYOK）無效或遺失。請重新登入或檢查提供者 API 金鑰設定。",
}
