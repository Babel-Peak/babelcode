export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Babel Code automatisch aanvullen",
  ...
  "kilocode:autocomplete.codeAction.title": "Babel Code: Voorgestelde bewerkingen",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Babel Code automatisch aanvullen wordt geblokkeerd door een conflict met GitHub Copilot. Schakel de inline suggesties van Copilot uit om dit op te lossen.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Babel Code Autocomplete is gepauzeerd. Mogelijke oorzaken: je Kilo-account heeft geen credits meer, of je geconfigureerde API-sleutel (BYOK) heeft de quotumlimiet bereikt. Voeg Kilo-credits toe of controleer je API-sleutelconfiguratie om autocomplete te hervatten.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Credits toevoegen",
  "kilocode:autocomplete.authError.message":
    "Babel Code Autocomplete is gepauzeerd vanwege een authenticatieprobleem. Mogelijke oorzaken: je bent niet aangemeld bij Kilo, of je API-sleutel (BYOK) is ongeldig of ontbreekt. Meld je opnieuw aan of controleer de API-sleutelinstellingen van je provider.",
}
