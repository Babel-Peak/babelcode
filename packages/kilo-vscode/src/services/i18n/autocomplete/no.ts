export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Babel Code autofullføring",
  ...
  "kilocode:autocomplete.codeAction.title": "Babel Code: Foreslåtte redigeringer",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Babel Code autofullføring blokkeres av en konflikt med GitHub Copilot. For å fikse dette må du deaktivere Copilots inline-forslag.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Babel Code autofullføring er satt på pause. Mulige årsaker: Kilo-kontoen din har ingen gjenværende kreditter, eller den konfigurerte API-nøkkelen (BYOK) har nådd kvotegrensen. Legg til Kilo-kreditter eller kontroller API-nøkkelkonfigurasjonen for å gjenoppta autofullføring.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Legg til kreditter",
  "kilocode:autocomplete.authError.message":
    "Babel Code autofullføring er satt på pause på grunn av et autentiseringsproblem. Mulige årsaker: du er ikke logget på Kilo, eller API-nøkkelen din (BYOK) er ugyldig eller mangler. Logg inn igjen eller kontroller innstillingene for leverandørens API-nøkkel.",
}
