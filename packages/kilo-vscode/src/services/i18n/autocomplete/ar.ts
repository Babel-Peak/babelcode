export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "الإكمال التلقائي في Babel Code",
  ...
  "kilocode:autocomplete.codeAction.title": "Babel Code: تعديلات مقترحة",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "يتم حظر الإكمال التلقائي في Babel Code بسبب تعارض مع GitHub Copilot. لإصلاح ذلك، يجب تعطيل اقتراحات Copilot المضمنة.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "تم إيقاف الإكمال التلقائي في Babel Code مؤقتا. الأسباب المحتملة: لا توجد أرصدة متبقية في حساب Kilo الخاص بك، أو أن مفتاح API المكون (BYOK) وصل إلى حد الحصة. أضف أرصدة Kilo أو تحقق من إعدادات مفتاح API لاستئناف الإكمال التلقائي.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "إضافة أرصدة",
  "kilocode:autocomplete.authError.message":
    "تم إيقاف الإكمال التلقائي في Babel Code مؤقتا بسبب مشكلة مصادقة. الأسباب المحتملة: لم تسجل الدخول إلى Kilo، أو أن مفتاح API (BYOK) غير صالح أو مفقود. يرجى تسجيل الدخول مرة أخرى أو التحقق من إعدادات مفتاح API للمزود.",
}
