export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Autocompletado de Babel Code",
  ...
  "kilocode:autocomplete.codeAction.title": "Babel Code: Ediciones sugeridas",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "El autocompletado de Babel Code está bloqueado por un conflicto con GitHub Copilot. Para solucionarlo, debes deshabilitar las sugerencias en línea de Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "El autocompletado de Babel Code se ha pausado. Posibles causas: tu cuenta de Kilo no tiene créditos restantes, o tu clave de API configurada (BYOK) alcanzó su límite de cuota. Agrega créditos de Kilo o revisa la configuración de tu clave de API para reanudar el autocompletado.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Añadir créditos",
  "kilocode:autocomplete.authError.message":
    "El autocompletado de Babel Code se ha pausado por un problema de autenticación. Posibles causas: no has iniciado sesión en Kilo, o tu clave de API (BYOK) no es válida o falta. Vuelve a iniciar sesión o revisa la configuración de la clave de API de tu proveedor.",
}
