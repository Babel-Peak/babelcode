export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Babel Code 自动补全",
  ...
  "kilocode:autocomplete.codeAction.title": "Babel Code：建议的编辑",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Babel Code 自动补全因与 GitHub Copilot 冲突而被阻止。要修复此问题，必须禁用 Copilot 的内联建议。",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Babel Code 自动补全已暂停。可能原因：你的 Kilo 账户没有剩余额度，或你配置的 API 密钥（BYOK）已达到配额限制。请添加 Kilo 额度或检查 API 密钥配置以恢复自动补全。",
  "kilocode:autocomplete.creditsExhausted.addCredits": "添加额度",
  "kilocode:autocomplete.authError.message":
    "Babel Code 自动补全因身份验证问题已暂停。可能原因：你尚未登录 Kilo，或你的 API 密钥（BYOK）无效或缺失。请重新登录或检查提供商 API 密钥设置。",
}
