export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Saisie automatique Babel Code",
  ...
  "kilocode:autocomplete.codeAction.title": "Babel Code : modifications suggérées",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "La saisie automatique Babel Code est bloquée par un conflit avec GitHub Copilot. Pour résoudre ce problème, vous devez désactiver les suggestions en ligne de Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "La saisie semi-automatique de Babel Code a été mise en pause. Causes possibles : votre compte Kilo n’a plus de crédits, ou votre clé API configurée (BYOK) a atteint sa limite de quota. Ajoutez des crédits Kilo ou vérifiez la configuration de votre clé API pour reprendre la saisie semi-automatique.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Ajouter des crédits",
  "kilocode:autocomplete.authError.message":
    "La saisie semi-automatique de Babel Code a été mise en pause en raison d’un problème d’authentification. Causes possibles : vous n’êtes pas connecté à Kilo, ou votre clé API (BYOK) est invalide ou manquante. Reconnectez-vous ou vérifiez les paramètres de clé API de votre fournisseur.",
}
