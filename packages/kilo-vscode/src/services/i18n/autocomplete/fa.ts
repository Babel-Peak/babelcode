...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "تکمیل خودکار Babel Code",
  ...
  "kilocode:autocomplete.codeAction.title": "Babel Code: ویرایش‌های پیشنهادی",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "تکمیل خودکار Babel Code به دلیل تعارض با GitHub Copilot مسدود شده است. برای رفع این مشکل، باید پیشنهادات درون‌خطی Copilot را غیرفعال کنید.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "تکمیل خودکار Babel Code متوقف شده است. دلایل احتمالی: حساب Kilo شما اعتبار کافی ندارد، یا کلید API پیکربندی‌شده (BYOK) به سقف مجاز خود رسیده است. برای از سرگیری تکمیل خودکار، اعتبار Kilo اضافه کنید یا تنظیمات کلید API خود را بررسی کنید.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "افزودن اعتبار",
  "kilocode:autocomplete.authError.message":
    "تکمیل خودکار Babel Code به دلیل مشکل احراز هویت متوقف شده است. دلایل احتمالی: وارد Kilo نشده‌اید، یا کلید API (BYOK) شما نامعتبر یا وارد نشده است. لطفاً دوباره وارد شوید یا تنظیمات کلید API ارائه‌دهنده خود را بررسی کنید.",
}
