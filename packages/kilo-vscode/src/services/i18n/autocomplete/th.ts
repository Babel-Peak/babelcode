export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "การเติมข้อความอัตโนมัติของ Babel Code",
  ...
  "kilocode:autocomplete.codeAction.title": "Babel Code: การแก้ไขที่แนะนำ",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "การเติมข้อความอัตโนมัติของ Babel Code ถูกบล็อกเนื่องจากขัดแย้งกับ GitHub Copilot หากต้องการแก้ไข คุณต้องปิดข้อเสนอแนะแบบอินไลน์ของ Copilot",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "การเติมข้อความอัตโนมัติของ Babel Code ถูกพักไว้ สาเหตุที่เป็นไปได้: บัญชี Kilo ของคุณไม่มีเครดิตเหลืออยู่ หรือคีย์ API ที่กำหนดค่าไว้ (BYOK) ถึงขีดจำกัดโควตาแล้ว เพิ่มเครดิต Kilo หรือตรวจสอบการกำหนดค่าคีย์ API เพื่อเริ่มใช้การเติมข้อความอัตโนมัติต่อ",
  "kilocode:autocomplete.creditsExhausted.addCredits": "เพิ่มเครดิต",
  "kilocode:autocomplete.authError.message":
    "การเติมข้อความอัตโนมัติของ Babel Code ถูกพักไว้เนื่องจากปัญหาการยืนยันตัวตน สาเหตุที่เป็นไปได้: คุณไม่ได้ลงชื่อเข้าใช้ Kilo หรือคีย์ API (BYOK) ของคุณไม่ถูกต้องหรือหายไป โปรดลงชื่อเข้าใช้อีกครั้งหรือตรวจสอบการตั้งค่าคีย์ API ของผู้ให้บริการ",
}
