export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Babel Code otomatik tamamlama",
  ...
  "kilocode:autocomplete.codeAction.title": "Babel Code: Önerilen düzenlemeler",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Babel Code otomatik tamamlama, GitHub Copilot ile çakışma nedeniyle engelleniyor. Bunu düzeltmek için Copilot'un satır içi önerilerini devre dışı bırakmalısınız.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Babel Code otomatik tamamlama duraklatıldı. Olası nedenler: Kilo hesabınızda kalan kredi yok veya yapılandırılmış API anahtarınız (BYOK) kota sınırına ulaştı. Otomatik tamamlamayı sürdürmek için Kilo kredisi ekleyin veya API anahtarı yapılandırmanızı kontrol edin.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Kredi ekle",
  "kilocode:autocomplete.authError.message":
    "Babel Code otomatik tamamlama bir kimlik doğrulama sorunu nedeniyle duraklatıldı. Olası nedenler: Kilo'da oturum açmadınız veya API anahtarınız (BYOK) geçersiz ya da eksik. Lütfen tekrar oturum açın veya sağlayıcı API anahtarı ayarlarınızı kontrol edin.",
}
