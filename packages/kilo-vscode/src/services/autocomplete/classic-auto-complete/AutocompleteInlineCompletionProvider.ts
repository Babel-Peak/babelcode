 ...
 */
export const INLINE_COMPLETION_ACCEPTED_COMMAND = "babel-code.new.autocomplete.inline-completion.accepted"
  ...
  public async provideInlineCompletionItems_Internal(
    ...
    try {
      ...
      if (matchingResult !== null) {
        ...
        vscode.commands.executeCommand("setContext", "babel-code.new.autocomplete.hasSuggestions", true)
