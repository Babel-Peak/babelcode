...
export const registerAutocompleteProvider = async (
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("babel-code.new.autocomplete.reload", async () => {
      await autocompleteManager.load()
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("babel-code.new.autocomplete.codeActionQuickFix", async () => {
      return
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("babel-code.new.autocomplete.cancelSuggestions", () => {
      vscode.commands.executeCommand("editor.action.inlineSuggest.hide")
      vscode.commands.executeCommand("setContext", "babel-code.new.autocomplete.hasSuggestions", false)
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("babel-code.new.autocomplete.generateSuggestions", async () => {
      autocompleteManager.codeSuggestion()
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("babel-code.new.autocomplete.showIncompatibilityExtensionPopup", async () => {
      await autocompleteManager.showIncompatibilityExtensionPopup()
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("babel-code.new.autocomplete.disable", async () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("babel-code.new.autocomplete.nextEdit.acceptOrJump", async () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("babel-code.new.autocomplete.nextEdit.dismiss", () => {
  ...
  context.subscriptions.push(
    vscode.workspace.onDidChangeConfiguration((e) => {
      if (e.affectsConfiguration("babel-code.new.autocomplete")) {
