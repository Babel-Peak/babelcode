...
export class DiffViewerProvider implements vscode.Disposable {
  public static readonly viewType = "babel-code.new.DiffViewerPanel"
  ...
  /**
   * Entry point for the `babel-code.new.showChanges` command. Composes the
  ...
  private onWebviewReady(): void {
    ...
    void this.panel.webview.postMessage({
      ...
      languageOverride: vscode.workspace.getConfiguration("babel-code.new").get<string>("language"),
